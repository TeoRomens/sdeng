...
abstract class AppColors {
  ...
  /// The blue gray primary color and swatch.
  ...
  static const Color inputEnabled = Color(0xFFFFFFFF);
  ...
  /// The shadow color.
  static const Color shadow = Color(0xFFe5e8eb);
  ...
  static const Color outline = Color(0x33000000);

  /// The outline on dark color.
  static const Color outlineOnDark = Color(0x29FFFFFF);

  /// The primary color of application.
  static const Color primary = Color(0xFF561DE2);

  /// The dark primary color of application.
  static const Color primaryDark = Color(0xFF3C149E);

  /// The light primary color of application.
  static const Color primaryLight = Color(0xFF9381FF);
