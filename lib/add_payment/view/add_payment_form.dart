      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(endIndent: 0, indent: 0, height: 20,),
            Wrap(
                children: [
                  ChoiceChip(
              ...
              ? Column(
                ...
                children: [
                  AppTextFormField(
                    ...
                    validator: (value) => bloc.state.amount.validator(value ?? '')?.text,
                  ),
                  ...
                  AppTextFormField(
                    ...
                    validator: (value) => bloc.state.cause.validator(value ?? '')?.text,
                  ),
                  ...
                  Wrap(
                    children: [
                      ChoiceChip(
                        ...
                        side:  paymentMethod == 1 ? const BorderSide(
                      ...
                      ChoiceChip(
                        ...
                        selectedColor: Colors.transparent,
                        side:  paymentMethod == 2 ? const BorderSide(
                            color: AppColors.primary
                        ) : BorderSide.none,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8)
                      ...
                      ChoiceChip(
                        ...
                        surfaceTintColor: Colors.white,
                        selectedColor: Colors.transparent,
                        side:  paymentMethod == 3 ? const BorderSide(
                            color: AppColors.primary
                        ) : BorderSide.none,
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8)
                  ...
                  AppTextFormField(
                    ...
                    validator: (value) => bloc.state.date.validator(value ?? '')?.text,
                  ),
                ],
              )
              : Column(
                        ...
                        child: Column(
                          children: [
                            Container(
                              ...
                              child: const Icon(FeatherIcons.dollarSign, size: 40,),
                            ),
                            const SizedBox(height: 16),
                            const Text('No formula found', style: TextStyle(
                                fontSize: 18,
                                letterSpacing: -0.2,
                            ...
                            const SizedBox(height: 8),
                            const Text("The athlete doesn't have been assigned to any payment formula",
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                fontSize: 15,
                                fontFamily: 'Inter',
                      ...
                      children: [
                        Card(
                          ...
                          child: ListTile(
                            ...
                            subtitle: Text('\$${bloc.state.formula!.quota1} before ${bloc.state.formula!.date1.dMY}'),
                        ...
                        bloc.state.formula!.full
                          ...
                          : Card(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Text('\$${bloc.state.formula!.quota2} before ${bloc.state.formula!.date2!.dMY}'),
                              titleTextStyle: const TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.w500,
                                  fontFamily: 'Inter',
                  ...
                  child: PrimaryButton(
                    onPressed: () async {
                      ...
                      if(sheet == 1){
                        ...
                        amount = formulaSelected == 1 ?  bloc.state.formula!.quota1 : bloc.state.formula!.quota2!;
                        method = paymentMethod == 1
                            ? PaymentMethod.transfer
                            : paymentMethod == 2
                            ? PaymentMethod.other
                      ...
                      await bloc.addPayment(
                        cause: cause,
                        amount: amount.toDouble(),
                        type: amount > 0 ? PaymentType.income : PaymentType.expense,
                        method: method
