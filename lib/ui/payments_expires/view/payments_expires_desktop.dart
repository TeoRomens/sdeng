...
class PayExpiresDesktop extends StatelessWidget {
  const PayExpiresDesktop({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      children: [
        Expanded(
            child: Center(
                child: SvgPicture.asset('assets/illustrations/payments.svg',
                  width: resHelper.deviceSize.width * 0.25,
                )
            )
        ),
        Expanded(
          child: BlocBuilder<PayExpiresBloc, PayExpiresState>(
